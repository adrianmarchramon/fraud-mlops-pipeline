...
this repository and quoted in each record; and for 0039, the generated Evidently report and
the live output of both `send_alert` paths, quoted in the record.
...
**0037–0039** in Phase 8 (monitoring and drift).
